...
You can install the published version of the package from this [link](https://pypi.org/project/stes-tools/) with `pip install stes-tools` or you can install the package in editable mode and clone the git repository.
